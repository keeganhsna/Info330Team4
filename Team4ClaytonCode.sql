...
--     PlayerPositionID INT FOREIGN KEY REFERENCES PLAYER_POSITION(PlayerPositionID) not null,
...
--     StatusTypeID INT FOREIGN KEY REFERENCES PLAYER_STATUS_TYPES(PlayerStatusTypeID) not null,
-- );
...
--     PlayerGameStats INT IDENTITY(1,1) primary key not null,
--     PlayerID INT FOREIGN KEY REFERENCES PLAYERS(PlayerID) not null,
--     GameID INT FOREIGN KEY REFERENCES GAMES(GameID) not null,
